...
public class Iterables2 {
	...
	public static Iterable<Integer> from(Integer first, Integer bound, Integer increment) {
		return new ArithmeticSeq(first, bound, increment);
	}

	public static Iterable<Integer> from(Integer first, Integer bound) {
		return new ArithmeticSeq(first, bound, 1);
	}
