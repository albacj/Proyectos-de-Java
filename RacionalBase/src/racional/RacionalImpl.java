...
public class RacionalImpl implements Racional {
   ...
   public RacionalImpl(Integer a, Integer b) {
	   if( a == null || b == null || b == 0 ) {
		   ...
		   throw new DenominadorCeroException("Parametros null o el denominador no puede ser cero");
	   } 
       if (b <0){
       		numerador = -a;
       		denominador = -b;
   ...
   public void setDenominador(Integer b){
	   if( b == 0) {
		   ...
		   throw new DenominadorCeroException("El denominador no puede ser cero");
	   }
	   denominador = b;
   }
